...
for (var i = 0; i < frutas.length; i++) {
    //Coloco o i no indice de frutas para pegar o valor de cada indice do vetor
...
/* O método forEach - significa para cada item do vetor dentro do parenteses colocamos a variável que irá receber o conteúdo de cada linha do vetor e
com o => {} informamos o bloco que irá executar para cada linha */
frutas.forEach( item => {
    console.log ('Item pelo forEach', item)
})
//Quando precisamos do índice também colocamos entre assim como no exxemplo abaixo
...
//Modificando o valor de um indice
